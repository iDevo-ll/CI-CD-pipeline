...
export const serverConfig: ServerOptions = {
  ...
  server: {
    ...
    autoPortSwitch: {
      enabled: true, // if disabled, the server will use the port specified in the environment variable PORT
      maxAttempts: 10, // maximum number of attempts to find an available port
      /**
       * Auto port switching strategy.
       * "increment" - increment the port number by 1
       * "predefined" - switch to a predefined port
       * "random" - switch to a random port
       */
      strategy: "increment",
    },
  },
  ...
  security: {
     ...
     * ```
     * 
     * @see https://github.com/Nehonix-Team/XyPriss/blob/master/docs/ROUTE_BASED_SECURITY.md
